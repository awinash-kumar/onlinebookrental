        ...
        <main class="p-4 min-vh-100" style="padding-top:40px!important;">
            <div class="container">
                <div class="form-wrap" style="background-color: #d1e7dd;">
                    <h2 style="text-align: center; font-size: 24px;font-weight: 700;padding-bottom: 33px;">Add User</h2>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation" id="password_confirmation"
                                        min="10" max="99" class="form-control" placeholder="Confirm Password">
