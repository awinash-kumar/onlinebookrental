    ...
    <div class="panel panel-default bg-white" >
        <div class="panel-body  max-w-xl m-auto border-purple-300 border mt-10 p-12 py-8">
            <h1
                ...
                Make A Payment</h1>
            <form action="{{ route('return.store', ['order_id' => $returnitems->order_id]) }}" method="POST" id="card-form">
                @csrf
                <div class="mb-3">
                    <label for="card-name" class="inline-block font-bold mb-2 uppercase text-sm tracking-wider">Payment</label>
                    <input disabled value="{{number_format($payAmount,2)}}" type="text" name="name" id="card-name"
