...
<section>
    <div class="container">
        <h2 class="text_col mt-3" style="text-align: center;">Order List</h2>
        ...
        <div class="shopping-cart mt-5">
            ...
            @foreach($userorderdetail as $book)
            ...
            <div class="product d-flex" data-book-id="{{ $book->book_id}}">
                ...
                <div class="product-price text_col" id="rentalPrice" readonly>{{ $book->rent_price}}</div>
